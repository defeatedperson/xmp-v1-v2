...
func writeMenu(statusText string) {
	fmt.Println("\n========================================")
	fmt.Println("   XMP XCC Lite - Windows 管理工具")
	fmt.Println("========================================")
	fmt.Println("")
	fmt.Println("当前状态:")
...
func startMonitor() bool {
	...
	fmt.Println("========================================")
	fmt.Println("")
	fmt.Println("XCC程序启动时会出现控制台窗口，这是正常现象。")
...
func main() {
	...
	for {
		...
		if !configured {
			...
			options = append(options, "1. 启动XCC")
			options = append(options, "2. 停止XCC")
